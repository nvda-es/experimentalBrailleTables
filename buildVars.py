...
addon_info = {
	...
	"addon_name": "experimentalBrailleTables",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary": _("Tablas braille experimentales"),
	# Add-on description
	...
	# version
	"addon_version": "2024.10.19",
	# Author(s)
	"addon_author": "Asociación Comunidad Hispanohablante de NVDA <contacto@nvda.es>",
	# URL for the add-on documentation support
	"addon_url": "https://github.com/nvda-es/experimentalBrailleTables",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/nvda-es/experimentalBrailleTables",
...
brailleTables = {
	"Es-Es-G0-experimental.utb": {
		"displayName": _("Experimental: Español computerizado de 8 puntos"),
		"contracted": False,
		"input": True,
		"output": True
	},
	"es-g1-experimental.ctb":{
		"displayName": _("Experimental: Español grado 1"),
		"contracted": False,
		"input": True,
		"output": True
	},
	"es-g2-experimental.ctb": {
		"displayName": _("Experimental: Español grado 2"),
		"contracted": True,
		"input": True,
		"output": True
	},
	"grc-international-es-experimental.utb":{
		"displayName": _("Experimental: Español para texto griego"),
		"contracted": False,
		"input": True,
		"output": True
	},
	"ca-g1-experimental.ctb":{
		"displayName": _("Experimental: Catalán grado 1"),
		"contracted": False,
		"input": True,
		"output": True
	}
